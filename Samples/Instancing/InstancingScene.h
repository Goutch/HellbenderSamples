...
public:
	...
	InstancingScene() {
		fragment_shader.loadGLSL("shaders/InstancedPosition.frag",SHADER_STAGE_FRAGMENT);
		vertex_shader.loadGLSL("shaders/InstancedPosition.vert",SHADER_STAGE_VERTEX);
